...
import com.example.endingwork.bean.UserInfo;
import com.example.endingwork.database.UserDBHelper;
import com.example.endingwork.util.DateUtil;
import com.example.endingwork.util.ViewUtil;
...
public class LoadActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990108 强仟仟"};
