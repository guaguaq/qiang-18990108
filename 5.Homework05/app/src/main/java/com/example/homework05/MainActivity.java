...
import com.example.homework05.bean.UserInfo;
import com.example.homework05.database.UserDBHelper;
import com.example.homework05.util.DateUtil;
import com.example.homework05.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private String[] typeArray = { "教师用户", "学生用户","18990108强仟仟"};
    ...
    private void initTypeSpinner() {
        ...
        ArrayAdapter<String> typeAdapter = new ArrayAdapter<String>(this,
                ...
                R.layout.activity_select, typeArray);

        // 设置数组适配器的布局样式

        typeAdapter.setDropDownViewResource(R.layout.activity_dropdown);
